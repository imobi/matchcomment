...
rest.Dispatcher.add_models({
  'sport' : (models.Sport, rest.READ_ONLY_MODEL_METHODS),
  'league' : (models.League, rest.READ_ONLY_MODEL_METHODS),
  'match' : (models.Match, rest.READ_ONLY_MODEL_METHODS),
  'comment' : (models.Comment, ['GET_METADATA', 'GET', 'POST', 'PUT']),
})
