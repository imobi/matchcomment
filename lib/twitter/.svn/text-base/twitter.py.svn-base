...
class Api(object):
  ...
  def __init__(self,
    ...
    '''
    #self.SetCache(cache) # throws error NotImplementedError: Only tempfile.TemporaryFile is available for use
  ...
  def _FetchUrl(self,
    ...
    #if encoded_post_data or no_cache or not self._cache or not self._cache_timeout: #throws error AttributeError: 'Api' object has no attribute '_cache'
    if encoded_post_data:
      ...
      #last_cached = self._cache.GetCachedTime(key)#throws error AttributeError: 'Api' object has no attribute '_cache'
    ...
    try:
      response = opener.open(url, encoded_post_data)
      url_data = self._DecompressGzippedResponse(response)
      #self._cache.Set(key, url_data)#throws error AttributeError: 'Api' object has no attribute '_cache'
